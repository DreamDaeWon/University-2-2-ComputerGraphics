...
bool bMoveCamera{}; // 카메라를 마우스로 움직일 수 있게 할 건지? 
...
{ //--- 윈도우 생성하기
	...
	//InitBuffers(&LineArt);
	//Create_Line_Pos(&LineArt, 0.f, 0.f, 0.f, 0.f, 0.f, -25.f, glm::vec3(1.f, 1.f, 1.f), glm::vec3(0.f, 0.f, 1.f));
	//InitBuffers(&LineArt);

	Create_Line_Pos(&LineArt, -10.f, 0.f, 5.f, 10.f, 0.f, 5.f);
	InitBuffers(&LineArt);
	Create_Line_Pos(&LineArt, -40.f, 0.f, 60.f, 40.f, 0.f, 60.f);
	InitBuffers(&LineArt);




	Create_Line_Pos(&LineArt, -10.f, 0.f, 5.f, -40.f, 0.f, 60.f);
	InitBuffers(&LineArt);
...
GLvoid KeyInput(unsigned char key, int x, int y)
{
	...
	if (key == 'l')
	{
		bMoveCamera = false; // 카메라를 마우스로 움직일 수 있게 할 건지? 

	}
	if (key == 'L')
	{
		bMoveCamera = true; // 카메라를 마우스로 움직일 수 있게 할 건지? 
