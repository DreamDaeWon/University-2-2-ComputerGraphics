...
{ //--- 윈도우 생성하기
	...
	g_WinID = glutCreateWindow("OGWork-25"); // 윈도우 생성(윈도우 이름)
	...
	Create_Obj_Want_Color("obj_file\\cube3.obj",glm::vec3(1,1,1), &AllArt_Light, 0, 0, 3, 1, 1, 1);
	Init_light_Buffers(&AllArt_Light);

	Create_Obj_Want_Color("obj_file\\sphere.obj", glm::vec3(1.f,0.f,0.f), &AllArt, 0, 0, 0, 5, 5, 5);
	Init_light_Buffers(&AllArt);

	Create_Obj_Want_Color("obj_file\\sphere.obj", glm::vec3(0.f, 1.f, 0.f), &AllArt, 0, 0, -1, 3, 3, 3);
	Init_light_Buffers(&AllArt);

	Create_Obj_Want_Color("obj_file\\sphere.obj", glm::vec3(0.f, 0.f, 1.f), &AllArt, 0, 0, -2, 1, 1, 1);
	Init_light_Buffers(&AllArt);
