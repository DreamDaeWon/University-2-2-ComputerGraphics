...
struct DWArt
{
	...
	GLfloat vMove[3]{}; // 객체가 원점에서 얼마만큼 움직이는지?
...
GLvoid Create_Cube(vector<DWArt*>* pVec, GLfloat _CX, GLfloat _CY, GLfloat _CZ, GLfloat _rx, GLfloat _ry, GLfloat _rz); // 원하는 벡터에 원하는 두 점을 잇는 직선 추가
...
// 공전
	...
	glm::vec3 revolutionAxisX(1.0f, 0.0f, 0.0f); // Y축 기준
	...
	glm::vec3 revolutionAxisZ(0.0f, 0.0f, 1.0f); // Y축 기준
